...
def car_categories_gate(cat_list, img_224, model):
...
def predict(image_path, model_id='smur0Fd9e-844AmkGCDlSi-bSg3yVrcC'):
	...
	response = requests.post(url, auth=requests.auth.HTTPBasicAuth(model_id, ''), files=data)
